...
<div class="card-body">
    <div class="btn-group"> 
        <button data-toggle="modal" data-target="#AddwarehouseModal" class="end btn btn-primary">+Add New</button>  
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Total warehouse ({{ $warehouse->count() }})</h4>
            </div>  
            <div class="table-responsive " >
                <table class="table table-white " >
                        ...
                        <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button data-target="#updatedataModal__{{ $warehouse->id }}" data-toggle="modal"class="dropdown-item" href="javascript:void(0);">
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Edit</span>
                                                                                                                                     </button>
                                                    <button data-target="#delete_data__{{ $warehouse->id }}" data-toggle="modal" type="submit" class="dropdown-item" href="javascript:void(0);">
                                    ...
                                    <div class="modal fade" id="delete_data__{{ $warehouse->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    {{-- Modal For add  Update warehouse   --}}
                                    <div class="modal fade" id="updatedataModal__{{ $warehouse->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('warehouse.update',$warehouse->id) }}" method="POST">
                                                        @method('PUT')
                                                    @csrf
                                                    <label for="warehouse_name">Enter  Update warehouse Name</label>
                                                    <input type="text" name="warehouse_name" class=" form-control import" value="{{ $warehouse->warehouse_name }}" >
                                                        ...
                                                        <label for="warehouse_name">Enter  Update warehouse Address</label>
                                                        <input type="text" name="warehouse_address" class="form-control import" value="{{ $warehouse->warehouse_address }}" >
                                                        ...
                                                        <label for="warehouse_name">Enter  Update warehouse Phone</label>
                                                         <input type="text" name="warehouse_phone" class="form-control import" value="{{ $warehouse->warehouse_phone }}" >
                    ...
                    @endforeach
                                        ...
                                        {{-- {{ $warehouse->links('vendor.pagination.custom') }} --}}
                </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="warehouse_name" class="mt-1 form-control import" >
                    @error('warehouse_name')
                    <div class="alert alert-danger">
                        {{$message}}
                    </div>  
                ...
                <label for="warehouse_address">Enter warehouse Address</label>
                <input type="text" name="warehouse_address" class=" form-control import" >
                    @error('warehouse_address')
                    <div class="alert alert-danger">
                        {{$message}}
                    </div>  
                ...
                <label for="warehouse_phone">Enter warehouse Phone</label>
                <input type="text" name="warehouse_phone" class=" form-control import" >
                    @error('warehouse_phone')
                    <div class="alert alert-danger">
                        {{$message}}
                    </div>  
        ...
        $(document).ready(function() {
            ...
            $('.select_all').change(function() {
                ...
                $('#mass_delete').click(function() {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ route('warehouse.bulkDelete') }}",
                        data: {
                            'ids': ids
                        },
