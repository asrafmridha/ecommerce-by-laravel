                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" value="{{ $product->name }}" class=" form-control import">
                                    @error('name')
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <input type="number" name="unit" class=" form-control import" value="{{ $product->unit }}" >
                                    @error('unit')
                                        <div class="alert alert-danger">
                                            {{$message}}
                                        </div>  
                        ...
                        <div class="row">
                            <div class="col-6 mt-2">
                                ...
                                <input type="text" name="purchase_price" class=" form-control import" value="{{ $product->purchase_price }}">
                            ...
                            <div class="col-6 mt-2">
                                ...
                                <input type="text" name="selling_price" class=" form-control import" value="{{ $product->selling_price }}">
                                    @error('selling_price')
                                        <div class="alert alert-danger">
                                            {{$message}}
                                        </div>  
                    ...
                    <div class="col-md-6">
                        <div class="col-12">
                              <label class="h5" for="code">Product Code</label>
                                <input type="text" name="code" class="form-control import"  value="{{ $product->code }}">
                                    @error('code')
                                        <div class="alert alert-danger">
                                            {{$message}}
                                        </div>  
                        ...
                        <div class="col-8 mt-2">
                              <label class="h5" for="tags">Tags*</label>
                                <input type="text" name="tags" class=" form-control import" value="{{ $product->tags }}">
                                    @error('tags')
                                        <div class="alert alert-danger">
                                            {{$message}}
                                        </div>  
                        ...
                        <div class="col-12 mt-2">
                              <label class="h5" for="discount_price">Discount Price*</label>
                                <input type="text" name="discount_price" class=" form-control import" value="{{ $product->discount_price }}">
                        ...
                        <div class="col-12 mt-2">
                              <label class="h5" for="stock_quantity">Stock*</label>
                                <input type="text" name="stock_quantity" class=" form-control import" value="{{ $product->stock_quantity }}">
                         ...
                         <div class="col-8 mt-2">
                              <label class="h5" for="size">Size*</label>
                                <input  type="text" name="size" class=" form-control import" value="{{ $product->size }}">
                                    @error('size')
                                        <div class="alert alert-danger">
                                            {{$message}}
                                        </div>  
    ...
    <div class="col-xl-4 col-md-6 col-12">
        ...
        <div class="card card-statistics ">
            ...
            <div class="card-body statistics-body">
                  ...
                  <div class="col-12">
                        <div class="form-group">
                            <img src="{{ asset('uploads/product/'.$product->thumbnails) }}" alt="" height="80px" width="120px">
                      ...
                      <div class="col-12">
                            ...
                            @if(json_decode($product->images)!=null)
                                @foreach(json_decode($product->images) as $picture)
                                        <img src="{{ asset('uploads/product/'.$picture) }}" style="height:120px; width:200px"/>
                                @endforeach
