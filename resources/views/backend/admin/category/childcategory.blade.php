    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Total subcategory ({{ $childcategory->count() }})</h4>
            </div>  
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button data-target="#updatesubcategoryModal__{{ $childcategory->id }}" data-toggle="modal"class="dropdown-item" href="javascript:void(0);">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('subcategory.update',$childcategory->id) }}" method="POST">
                                                        @method('PUT')
                                                    @csrf
                                                   <label for="subcategory_name">Category Name</label>
                                                    <select class="form-control" aria-label="Default select example" name="category_id">
                                                        ...
                                                        <option value="{{ $childcategory->category->id }}">{{ $childcategory->category->category_name }}</option>
                                                    </select>
                                                        ...
                                                        <input type="text" name="sub_category_name" class="mt-1 form-control import" value="{{ $childcategory->sub_category_name }}" >
