...
<div class="super_container">
   ...
   @if(($banner_product==null))
        <h1 class="m-5">No Product Found</h1>
	@else	
	<div class="banner">
		<div class="banner_background" style="background-image:url({{ asset('uploads/product/'.$banner_product->thumbnails) }})" ></div>
			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						...
						<div class="button banner_button"><a href="{{ route('product.details',$banner_product->slug) }}">Shop Now</a></div>
					</div>
				</div>
			</div>
		</div>
